...
from django.urls import path, include # Include is used to reference other URLconfs in the project  
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="bigbgroup001@gmail.com"),
...
urlpatterns = [
    ...
    path('api/trades/', include('trades.urls')), # Include the trades app URLs
